...
class MarkdownDocsGenerator {
    ...
    extractTests(content, filePath) {
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            if (braceLevel < (currentDescribe === null || currentDescribe === void 0 ? void 0 : currentDescribe.level)) {
    ...
    generateTestLink(filePath, lineNumber, describeName, testName) {
        ...
        // Create a GitHub-style link (you can modify this based on your repository structure)
